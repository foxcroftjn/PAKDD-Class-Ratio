...
if __name__ == "__main__":
    ...
    evaluation = Evaluation(evaluation_data_loader, exp_name, args.model_output_dir, len(label_list), args.model_type, 'validation')
    ...
    test = Evaluation(test_data_loader, exp_name, args.model_output_dir, len(label_list), args.model_type, 'test')
